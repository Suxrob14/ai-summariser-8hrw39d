    """
    Ai Summariser 8hrw39d
    =====================
    Command-line assistant leveraging transformer models to analyse content efficiently.
    ...
    APP_NAME    = "Ai Summariser 8hrw39d"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Command-line assistant leveraging transformer models to analyse content efficiently.")
